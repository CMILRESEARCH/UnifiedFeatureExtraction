...
class Segmnt(FeatureBuilder):
    ...
    def segmentSingleTubule(self, patch, mask):
    ...
    def build_feature(self, ftu):
        ...
        self.segmentSingleTubule(self.tubule.patch, self.tubule.mask)
...
class EpmFtr(FeatureBuilder):
    ...
    def measureEpithelium(self, ept_msk, mask_):
        ...
        self.tubule.add_feature('epm_mean', mean(distances))
        self.tubule.add_feature('epm_harmonic_mean', harmonic_mean(distances))
        self.tubule.add_feature('epm_median', median(distances))
        self.tubule.add_feature('epm_median_low', median_low(distances))
        self.tubule.add_feature('epm_median_high', median_high(distances))
        self.tubule.add_feature('epm_stdev', stdev(distances))
        self.tubule.add_feature('epm_variance', variance(distances))
